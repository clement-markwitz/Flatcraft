...
import fr.univartois.butinfo.ihm.flatcraft.controller.TerrariaController;
...
public class TerrariaApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("./view/Terraria.fxml"));
        Parent viewContent = fxmlLoader.load();
        TerrariaController controller = fxmlLoader.getController();
